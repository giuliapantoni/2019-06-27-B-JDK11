...
public class CrimesController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	if(mese== null) {
    		txtResult.appendText("Errore, devi prima selezionare un mese!\n");
    		return;
    	}
    	...
    	txtResult.appendText("Elenco dei reati con relativo peso: \n");
    	for(Adiacenza a : this.model.getRisultato()) {
